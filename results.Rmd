...
.libPaths("C:\\Users\\Andrzej\\Documents\\.checkpoint\\2016-04-01\\lib\\x86_64-w64-mingw32\\3.2.3")
library(reshape2)
library(dplyr)
library(ggplot2)
...
for (lib in LIBRARIES)
{
    ...
    for (benchmark in BENCHMARKS)
    {
        ...
        for (i in 1:nrow(testnames)) 
        {
            ...
            myColors = c("#5AAC45", "#636363", "#636363", "#E6191A", "#636363", "#636363")
            if (lib=="cublas")
                myColors = c("#E6191A", "#5AAC45", "#636363")#, "#636363", "#5AAC45", "#636363")
            ...
            png(image.path, width=400, height=350, type="cairo")
                print(ggplot(data.to.plot, 
                    ...
                    geom_hline(yintercept = 0, color="grey") + 
                    geom_vline(xintercept = 0.4, color="grey") +
                    scale_shape_manual(values=c(25,24,22,21,23,25)) +
                    scale_color_manual(values=rbColors) +
                    scale_fill_manual(values=rbColors)
