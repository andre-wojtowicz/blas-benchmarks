...
|5.|[Intel Core i5-3317U](http://ark.intel.com/products/65707/Intel-Core-i5-3317U-Processor-3M-Cache-up-to-2_60-GHz)|[NVIDIA GeForce GT 630M](http://www.geforce.com/hardware/notebook-gpus/geforce-gt-630m/specifications)|
...
for (lib in LIBRARIES)
{
    ...
    for (benchmark in BENCHMARKS)
    {
        ...
        for (i in 1:nrow(testnames)) 
        {
            ...
            myColors = c("#5AAC45", "#636363", "#636363", "#E6191A", "#636363")
            if (lib=="cublas")
                myColors = c("#E6191A", "#636363")#, "#636363", "#5AAC45", "#636363")
            ...
            rbColors = c("#F40000","#FF8000","#0094FF","#7F00FF","#E900FF","#00DD0E")
            ...
            png(image.path, width=400, height=350, type="cairo")
                print(ggplot(data.to.plot, 
                    ...
                    geom_hline(yintercept = 0, color="grey") + 
                    geom_vline(xintercept = 0.4, color="grey") +
                    scale_shape_manual(values=c(25,24,22,21,23)) +
                    scale_color_manual(values=rbColors) +
                    scale_fill_manual(values=rbColors)
