...
for (lib in LIBRARIES)
{
    ...
    for (benchmark in BENCHMARKS)
    {
        ...
        for (i in 1:nrow(testnames)) 
        {
            ...
            myColors = c("#5AAC45", "#636363", "#636363", "#636363", "#636363", "#636363", "#636363", "#E6191A")
            if (lib=="cublas")
            ...
            rbColors = c("#F40000","#FF8000","#0094FF","#7F00FF","#E900FF","#00DD0E","#B35807", "#7F006E")
            ...
            png(image.path, width=700, height=400, type="cairo")
                print(ggplot(data.to.plot, 
                    ...
                    geom_hline(yintercept = 0, color="grey") + 
                    geom_vline(xintercept = 90, color="grey") +
                    scale_shape_manual(values=c(25,24,22,21,23,25,24,22)) +
                    scale_color_manual(values=rbColors) +
                    scale_fill_manual(values=rbColors)
